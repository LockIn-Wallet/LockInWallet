...
async function main() {
  ...
  try {
    ...
    console.log("\n🔧 Setting up module interactions...");

    // Note: These calls need to come from the core contract since modules have onlyCore modifiers
    // Create function call data for the core contract to execute

    // For now, we'll note that module setup needs to be done post-deployment
    console.log("   ⚠️  Module interactions will be set up via core contract calls");
    console.log("   ℹ️  This is a design consideration - modules should reference each other through the core");
